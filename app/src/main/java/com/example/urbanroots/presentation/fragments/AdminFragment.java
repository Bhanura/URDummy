...
public class AdminFragment extends Fragment implements CropAdapter.AdminCropActionListener {

    private FirebaseAuth mAuth;
    private FirebaseFirestore db;
    private TextInputEditText cropNameEditText, priceEditText, descriptionEditText, statusEditText,
            soilTypeEditText, sunlightHoursEditText, wateringIntervalEditText, harvestTimeEditText;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        soilTypeEditText = view.findViewById(R.id.soilTypeEditText);
        sunlightHoursEditText = view.findViewById(R.id.sunlightHoursEditText);
        wateringIntervalEditText = view.findViewById(R.id.wateringIntervalEditText);
        harvestTimeEditText = view.findViewById(R.id.harvestTimeEditText);
        ...
        cropAdapter = new CropAdapter(cropList, true, this); // Pass isAdmin as true
        ...
        if (args != null && args.containsKey("cropId")) {
            ...
            selectedCrop.setSoilType(args.getString("soilType"));
            selectedCrop.setSunlightHours(args.getString("sunlightHours"));
            selectedCrop.setWateringInterval(args.getString("wateringInterval"));
            selectedCrop.setHarvestTime(args.getString("harvestTime"));
            ...
            soilTypeEditText.setText(selectedCrop.getSoilType());
            sunlightHoursEditText.setText(selectedCrop.getSunlightHours());
            wateringIntervalEditText.setText(selectedCrop.getWateringInterval());
            harvestTimeEditText.setText(selectedCrop.getHarvestTime());
    ...
    private void addCrop() {
        ...
        String sunlightHours = sunlightHoursEditText.getText().toString().trim();
        String wateringInterval = wateringIntervalEditText.getText().toString().trim();
        String harvestTime = harvestTimeEditText.getText().toString().trim();

        if (cropName.isEmpty() || priceStr.isEmpty() || description.isEmpty() || status.isEmpty() ||
                soilType.isEmpty() || sunlightHours.isEmpty() || wateringInterval.isEmpty() || harvestTime.isEmpty()) {
        ...
        cropData.put("soilType", soilType);
        cropData.put("sunlightHours", sunlightHours);
        cropData.put("wateringInterval", wateringInterval);
        cropData.put("harvestTime", harvestTime);
    ...
    public void onEdit(Crop crop) {
        ...
        soilTypeEditText.setText(crop.getSoilType());
        sunlightHoursEditText.setText(crop.getSunlightHours());
        wateringIntervalEditText.setText(crop.getWateringInterval());
        harvestTimeEditText.setText(crop.getHarvestTime());
        addCropButton.setVisibility(View.GONE);
        updateCropButton.setVisibility(View.VISIBLE);
    }
    ...
    private void clearInputFields() {
        ...
        sunlightHoursEditText.setText("");
        wateringIntervalEditText.setText("");
        harvestTimeEditText.setText("");
    }
